    ...
    <div class="footer-main">
        <div class="footer-main__inner">
            ...
            <div class="footer-col footer-col--links">
                <h4 class="footer-col__heading"><?php echo esc_html( travzo_get( 'travzo_footer_col2_heading', 'Quick Links' ) ); ?></h4>
                <?php
                wp_nav_menu( [
            ...
            <div class="footer-col footer-col--packages">
                <h4 class="footer-col__heading"><?php echo esc_html( travzo_get( 'travzo_footer_col3_heading', 'Our Packages' ) ); ?></h4>
            ...
            <div class="footer-col footer-col--contact">
                <h4 class="footer-col__heading"><?php echo esc_html( travzo_get( 'travzo_footer_col4_heading', 'Contact Us' ) ); ?></h4>
                ...
                <a href="<?php echo esc_url( $ftr_whatsapp_url ); ?>"
                   ...
                   rel="noopener noreferrer">
                    ...
                    <?php echo esc_html( travzo_get( 'travzo_footer_whatsapp_text', 'Chat on WhatsApp' ) ); ?>
                </a>
                ...
                wp_nav_menu( [
                    ...
                    'fallback_cb'    => function () {
                        ...
                        foreach ( $legal_links as $url => $label ) {
                            ...
                            printf( '<a href="%s">%s</a>', esc_url( $url ), $label );
                            $i++;
                        }
                    },
                ] );
